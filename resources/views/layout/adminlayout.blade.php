            ...
            <div class="page-sidebar-wrapper">
				...
				<div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <a href="{{route('systemadmin')}} " class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('adduserbyadmin')}} " class="nav-link ">
                                        <span class="title">add user</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('alldatabyadmin')}} " class="nav-link ">
                                        <span class="title">All user</span>
                                    </a>
                                </li>
                                  <li class="nav-item  ">
                                    <a href="{{route('approveduser')}} " class="nav-link ">
                                        <span class="title">Approved User</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                           ...
                           <i class="glyphicon glyphicon-object-align-bottom"></i>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="{{route('allquarter')}} " class="nav-link ">

            ...
            <div class="page-sidebar-wrapper">
				...
				<div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <a href="{{route('aco')}} " class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('approvefromoc')}} " class="nav-link ">
                                        <span class="title">approve user</span>
                                    </a>
                                </li>
                                
                                  <li class="nav-item  ">
                                    <a href="{{route('CheckComment')}} " class="nav-link ">
                                        <span class="title">Check Comment</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                           ...
                           <i class="glyphicon glyphicon-object-align-bottom"></i>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('addquarter')}}" class="nav-link ">
                                        <span class="title">Add Quarter</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="{{route('allQuarterAoc')}} " class="nav-link ">
